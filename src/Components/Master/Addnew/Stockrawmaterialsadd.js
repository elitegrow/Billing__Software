    ...
    <div class="layout-wrapper layout-content-navbar main" id='main'>
        <div class="layout-container">
            ...
            <nav class="navbar navbar-light nav-head mt-2 rounded">
                <span class="navbar-brand nav-text mb-0 h1 px-4">Raw Materials</span>
            </nav>
                            ...
                            <div class="card-body pt-3">
                                <form id="addEditForm" name="addEditForm" action="" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="mb-3 text-start">
                                        ...
                                        <label class="form-label" for="religion_name">Purchase Entry <span class="Form__Error">*</span></label>

                                        <input type="text" required="" class="form-control required" id="religion_name" name="religion_name" placeholder="Purchase Entry" />

                                    </div>
                                    
                                    <div class="mb-3 text-start">

                                    <label class="form-label" for="religion_name">Issues <span class="Form__Error">*</span></label>

                                    <input type="text" required="" class="form-control required" id="religion_name" name="religion_name" placeholder="Issues" />
...
export default Stockrawmaterialsadd