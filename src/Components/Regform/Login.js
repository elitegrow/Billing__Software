            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-2 pb-2">
                    <h5 class="card-title text-center  pb-3 fs-4">Admin Login </h5>
                  ...
                  <form class="row g-3 needs-validation text-start" novalidate="">
                    ...
                    <div class="col-12">
                      ...
                      <div class="input-group has-validation">
                        ...
                        <input type="text" name="username" class="form-control" id="yourUsername" placeholder='Enter your Mobile Number' required=""/>
